        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "album_cover_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="album cover ID"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "album_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="album ID"
                    ),
                ),
                ("title", models.CharField(max_length=256, verbose_name="album title")),
                (
                    "number_of_discs",
                    models.SmallIntegerField(verbose_name="number of discs"),
                ),
                (
                    "number_of_tracks",
                    models.SmallIntegerField(verbose_name="number of tracks"),
                ),
                (
                    "release_date",
                    models.DateField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "artist_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="artist ID"
                    ),
                ),
                (
                    "first_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "genre_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="genre ID"
                    ),
                ),
                (
                    "genre_name",
                    models.CharField(max_length=64, verbose_name="genre name"),
                ),
            ],
            options={
                "db_table": "genres",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "song_lyrics_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="Song lyrics ID"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "song_id",
                    models.AutoField(
                        primary_key=True, serialize=False, verbose_name="song ID"
                    ),
                ),
                ...
                (
                    ...
                    models.SmallIntegerField(
                        verbose_name="song length minutes component"
                    ),
                ),
                (
                    "length_seconds",
                    models.SmallIntegerField(
                        verbose_name="song length seconds component"
                    ),
                ),
            ],
            options={
